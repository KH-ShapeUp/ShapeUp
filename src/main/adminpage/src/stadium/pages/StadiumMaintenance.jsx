...
const seedTasks = [
  ...
  { id: 2, title: "샤워실 배수 청소", facility: "공용 구역", due: "11.16", priority: "medium", status: "진행중" },
  { id: 3, title: "풋살장 조명 교체", facility: "풋살장 A", due: "11.18", priority: "low", status: "대기" },
];
  ...
  return (
    <div className="stadium-alerts-page">
      ...
      <section className="alerts-grid">
        ...
        <article className="alerts-card">
          <h3>점검 일정 목록 ({filteredTasks.length}건)</h3>
          <ul className="maintenance-list">
            ...
            {!filteredTasks.length && <p className="empty">해당 조건의 일정이 없습니다.</p>}
          </ul>
        </article>
      </section>
    </div>
