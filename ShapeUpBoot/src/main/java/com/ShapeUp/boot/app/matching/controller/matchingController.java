...
public class matchingController {
	...
	public String matchingInsertPage(Model model) {
		List<matchingActivityVO> aList = mService.matchingCategory();
	...
	@ResponseBody
	public List<matchingActivityVO> searchCategory(@RequestParam String keyword) {
		List<matchingActivityVO> aList = mService.searchCategory(keyword);
